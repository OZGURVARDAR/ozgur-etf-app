...
try:
    ...
    # BOŞLUK TEMİZLİĞİ: Sadece verisi olan günleri tut, NaN olanları sil
    ...
    # --- TATİL GÜNLERİNİ ÇIKARMA VE GÖRSEL DÜZENLEME ---
    fig.update_xaxes(
        type='date',
        # Hafta sonlarını (Cumartesi-Pazar) grafikten tamamen siler
